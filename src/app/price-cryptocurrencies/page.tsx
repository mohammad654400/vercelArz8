...
export const metadata = {
  ...
  description: "مشاهده لیست قیمت لحظه‌ای بیش از 1300 ارز دیجیتال در صرافی ارز هشت. امکان فیلتر، مرتب‌سازی و جستجو برای انتخاب بهترین ارزها با قیمت‌های به‌روز.",
  robots: {
    index: true,
    follow: true,
  },
