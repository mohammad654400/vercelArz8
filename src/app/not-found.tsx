    ...
    <div className='base-style' style={{ gap: 0 }}>
      ...
      <div className='flex flex-col gap-y-12 md:gap-y-24 justify-center items-center  mt-[104px] md:mt-[232px]'>
        ...
        <div className='w-full grid grid-cols-2 md:grid-cols-4 grid-flow-row-dense gap-3'>
          ...
          <Link className='flex flex-col w-[183px] h-[183px] rounded-[20px] bg-third justify-center items-center gap-2 md:gap-7 justify-self-end  md:justify-self-center' href={"/contactus"}>
            <div className='w-[56px] h-[56px]'>
              <GeneralQuestions />
            </div>
