      ...
      <div className="full-screen px-5">
        <div className="flex gap-8 flex-wrap justify-center w-full md:justify-center lg:justify-between ">
          <section className="lg:px-0 px-5 md:w-2/3 w-full lg:w-[25%]">
            ...
            <p className="text-justify text-[14px] leading-10">صرافی ارز هشت، پلتفرم پیشرفته خرید، فروش و ترید ارزهای دیجیتال است که از سال ۱۳۹۷ فعالیت خود را آغاز کرده و با ارائه خدماتی امن، سریع و کاربرپسند، به یکی از انتخاب‌های اصلی معامله‌گران در ایران تبدیل شده است. با دسترسی به بیش از ۱۳۰۰ ارز دیجیتال و امکاناتی چون واریز و برداشت آسان، پشتیبانی ۲۴ ساعته و امنیت بالای تراکنش‌ها، ارز هشت تجربه‌ای مطمئن از معاملات دیجیتال را برای شما به ارمغان می‌آورد.</p>
          </section>
          ...
          <section className="flex flex-col gap-8 lg:w-[68%]">
            <nav className="flex flex-wrap gap-2 justify-center w-auto lg:justify-between  md:justify-center 1 ">
              ...
              <Link href={"https://app.arz8.com/"} className="flex justify-between px-2 items-center bg-transparent border border-[#3C3B41] rounded-lg w-[151px] h-[41px] dark:border-white  hover:text-primary hover:border-primary dark:hover:border-primary">
            ...
            <div className="hidden md:block">
              <div className="flex justify-between ">
                ...
                <section className="">
                  ...
                  <ul className="flex flex-col gap-4">
                    <li><Link  className="flex gap-x-2" href={"https://app.arz8.com/support"}> <TownyFour /> پشتیبانی آنلاین </Link></li>
