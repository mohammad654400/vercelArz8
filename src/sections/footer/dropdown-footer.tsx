    ...
    <div className="flex flex-col gap-4 p-4 rounded-lg">
      ...
      >
        <ul className="flex flex-col gap-4 mt-2 pl-4 text-[14px] cursor-pointer">
          ...
          <li><Link href="/coin" className="hover:text-primary">قیمت لحظه‌ای ارزها</Link></li>
          <li><Link href="/download" className="hover:text-primary">دانلود اپلیکیشن</Link></li>
          <li><Link href="/coin" className="hover:text-primary">گردونه شانس</Link></li>
      ...
      >
        <ul className="flex flex-col gap-4 mt-2 pl-4 text-[14px] cursor-pointer">
          ...
          <li className="flex items-center gap-2"><Phone /> 021-284299</li>
        </ul>
      </DropdownItem>
    </div>
  );
