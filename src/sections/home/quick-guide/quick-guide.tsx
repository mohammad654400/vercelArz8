...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "ارز های دیجیتال شکل خاصی از دارایی به صورت دیجیتال هستند که بر پایه علم رمزنگاری و با هدف حذف واسطه ها و کاهش تقلب و جلوگیری از جعل ایجاد شده اند. ویژگی خاصل این ارز ها غیر متمرکز بودن و شفاف بودن بلاکچین آنها میباشد.",
  },
  {
    question: "بیت کوین چیست؟",
    answer:
      "بیت کوین اولین نوع ارز دیجیتال هست که مبتنی بر بلاکچین ساخته شده است و در سال 2009 توسط شخص یا اشخاصی تحت عنوان ساتوشی ناکاموتو اختراع شد. با استفاده از بیت کوین میتوانید خرید و معامله کنید و به هر نقطه از جهان پول ارسال کنید.",
  },
  {
    question: "چگونه ارز دیجیتال بخرم؟",
    answer:
      "پس از ثبت نام در سایت ارز هشت و تکمیل فرایند احراز هویت و تایید حساب بانکی توسط پشتیبانی سایت اقدام به خرید ارز دیجیتال کنید. همچنین برای راهنمایی بیشتر میتوانید با پشتیبان های ارز هشت در ارتباط باشید",
  },
  {
    question: "چگونه ارز دیجیتال بفروشم؟",
    answer:
      "پس از ثبت نام و تایید هویت در ارز هشت ، میتوانید به قسمت واریز کیف پول ها رفته و دارایی دیجیتال خود را به کیف پول های ارز هشت انتقال بدید و سپس از قسمت فروش اقدام به فروش و تبدیل دارایی به تومان کنید.",
  },
  {
  ...
  },
  {
    ...
    answer: "با مراجعه به صفحه پنل کاربری و بخش کارت بانکی می‌توانید اقدام به ثبت و واریز ریالی کنید.",
