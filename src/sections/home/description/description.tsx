      ...
      <section className="w-full mx-auto">
        ...
        >
          ...
          <ol className="list-decimal list-inside space-y-1">
            <li>تنوع گسترده ارزهای دیجیتال: در صرافی ارز هشت می‌توانید به بیش از 1300 ارز دیجیتال محبوب و نوظهور دسترسی داشته باشید. از خرید بیت‌کوین (BTC) و اتریوم (ETH) گرفته تا آلتکوین‌های کمتر شناخته‌شده</li>
