  ...
  return (
    <div>
      ...
      <div className="flex gap-2 w-full justify-between items-center">
        <div className="font-bold text-[10px] md:text-lg hidden md:block">بلاگ ارز هشت</div>
        ...
        <button className="px-6 py-2 bg-primary rounded-xl text-background text-[10px] md:text-sm">
          مطالعه بیشتر{" "}
        </button>
      </div>
      ...
      <div className="overflow-x-auto whitespace-nowrap py-4 ">
        <div className="flex gap-4">
          ...
          {[...Array(4)].map((_, index) => (
            <div
              key={index}
              className="w-[277px] text-xs flex-shrink-0 bg-background shadow-md rounded-lg  py-[30px]"
            >
              <Image
