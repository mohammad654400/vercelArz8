    ...
    <div className="flex flex-col full-screen lg:h-[590px] h-auto pt-20 mb-[30px] xl:px-0"> 
      <div className="bg-[#242428] w-full h-full text-white text-center py-12 px-5 lg:py-10 lg:px-32"> 
        <div className="w-full h-full justify-center items-center flex flex-col lg:flex-row"> 
          ...
          <div className="w-full lg:w-[55%] gap-8 order-3 lg:order-1 h-full flex flex-col justify-center text-center lg:text-start lg:mt-0 mt-10"> 
          <div className="flex flex-col gap-6"> 
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-extrabold"> 
              دانلود اپلیکیشن صرافی ارزهشت 
            </h1> 
            <span className="text-xs lg:text-lg opacity-50 font-bold"> 
              با اپلیکیشن ارزهشت در یک صرافی تمام عیار معامله کنید. 
            </span> 
          </div> 
             
            <ul className="self-center lg:self-start text-start list-disc list-inside text-base sm:text-lg lg:text-xl font-semibold"> 
