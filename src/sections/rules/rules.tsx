...
export default function Rules() {
    ...
    return (
        <div className="base-style bg-background" style={{ gap: "0px" }}>
            <div className="flex bg-primary w-full rounded-[20px] p-[13px] items-center mt-[76px] lg:mt-[146px] lg:mb-[43px] mb-[40px]">
            ...
            {isDrawerOpen ? (
                <div
                    className="fixed bottom-0 left-0 w-full bg-[#FFFFFF]  shadow-[#9C9C9C40] shadow-[0px_0px_20.02px_0px_rgba(156,156,156,0.25)] rounded-t-[40px] h-[426px] z-20 "
                >
            ...
            <div className="hidden lg:flex flex-col  self-center mt-10">
                <h1 className="text-[35px] font-bold border-b-4 border-primary pb-4 w-auto text-center">
