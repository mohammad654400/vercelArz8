...
export default function ContactUs() {
  ...
  const [formData, setFormData] = useState<FormData>({ fullName: "", phoneNumber: "", message: "", });
  ...
  return (
    <main className="bg-background">
      ...
      <div className="overflow-x-hidden">
        <div className="max-w-[1200px] mx-auto relative h-[1100px] flex items-center justify-between gap-40 overflow-x-visible w-full">
          <ContactForm
