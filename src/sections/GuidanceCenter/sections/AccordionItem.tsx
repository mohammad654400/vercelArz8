...
const AccordionItem = forwardRef<HTMLDivElement, AccordionItemProps>(
  ({ title, children, videoLink }, ref) => {
    ...
    return (
      <div ref={ref} className="relative rounded-xl p-8 mb-4">
        {isOpen && (
          <div
        ...
        <div className="relative z-10">
          ...
          >
            <span className="text-[#000000] text-start text-base sm:text-xl font-semibold">
              {title}
            </span>
