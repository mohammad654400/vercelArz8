...
const Wage: React.FC = () => {
    ...
    return (
        <div  className="base-style bg-background">
            ...
            <section  className="flex flex-col gap-10 sm:gap-[60px] xl:gap-[100px] mt-[76px] sm:mt-[122px] lg:mt-32 mb-16 md:mb-36">
                ...
                <div className="flex flex-col gap-10 sm:gap-[50px] lg:gap-[80px]">
                    ...
                    <div className="flex flex-col  self-center ">
                        <h2 className="text-lg sm:text-[35px] font-bold border-b-4 border-primary pb-1 sm:pb-3 w-auto text-center">
