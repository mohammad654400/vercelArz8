...
export default function HeaderJob({ scrollToJobs }: { scrollToJobs: () => void }) {
    return (
        <div className="flex flex-col-reverse xl:flex-row justify-between items-center h-full w-full mt-20">
            <div className="flex flex-col w-full xl:w-[460px] z-10 gap-8">
                <h1 className="text-2xl sm:text-3xl xl:text-4xl font-extrabold ">فرصت های شغلی ارز هشت</h1>
                <span className="text-base sm:text-lg xl:text-sm font-normal  text-justify" style={{ lineHeight: "2.5rem" }}>
