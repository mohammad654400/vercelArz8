        ...
        <div className="py-[76px] lg:py-60 flex flex-col justify-center items-center gap-10 lg:gap-24 z-10">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-xs lg:text-[25px] text-justify mt-[13px] mb-5 lg:mt-10 lg:mb-[25px] leading-[35px] lg:leading-[70px]">
              ...
              اگر تخصصی در تست نفوذ دارید و به دنبال فرصتی برای اثبات مهارت‌های خود هستید، این فرصت استثنایی را از دست ندهید!<br />
              با شناسایی و گزارش باگ‌ها و آسیب‌پذیری‌های ارزهشت بر اساس قوانین ذکر شده، پس از بررسی و تأیید تیم امنیت، می‌توانید پاداش نقدی دریافت کنید.
