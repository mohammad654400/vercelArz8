                ...
                {levelsData.map((level, index) => {
                    ...
                    return (
                        <div
                            ...
                            className={`flex-shrink-0 px-4 py-2 rounded-[20px] text-sm font-semibold cursor-pointer transition-all duration-200 ${isSelected ? "bg-[#FFF6DD] text-[#FFC107]" : "bg-secondary text-sixth"
                                }`}
                        >
                            {level.level}
                        </div>
