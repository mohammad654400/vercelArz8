          ...
          <div className="w-full h-full justify-center items-center flex flex-col lg:flex-row">
            <article className="w-full order-3 lg:order-1 h-full flex flex-col justify-center text-center lg:text-start lg:mt-0 mt-10">
              <div className="flex flex-col">
                <h1 className="text-2xl sm:text-[26px] lg:text-[40px] font-extrabold">دانلود اپلیکیشن صرافی ارزهشت</h1>
                <p className="text-xs lg:text-lg mt-2 md:mt-5 font-bold">با اپلیکیشن ارزهشت در یک صرافی تمام عیار معامله کنید.</p>
              </div>
            ...
            <div className="w-[215px] h-[278px] mt-10 lg:mt-[30]  lg:w-[413px] lg:h-[534px]  order-2 flex justify-center lg:justify-end  items-center ">
              <Image alt="نمایش اپلیکیشن روی تلفن همراه" src={Phone} />
            </div>
          </div>
        </section>
        {showWaveDivider &&
          <div className="w-full flex justify-center text-[#242428] mt-[20px] sm:mt-[29px] md:mt-[25px] lg:mt-[39px]">
