export const schemaData = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://arz8.com/application",
      "name": "دانلود اپلیکیشن صرافی ارز هشت",
      "description": "با اپلیکیشن صرافی ارز هشت به دنیای خرید و فروش بیش از 1300 ارز دیجیتال وارد شوید. احراز هویت سریع، پشتیبانی ۲۴ ساعته و رابط کاربری حرفه‌ای.",
    ...
    },
    {
      ...
      "description": "دانلود اپلیکیشن صرافی ارز هشت برای معامله امن و سریع ارزهای دیجیتال با بیش از 1300 رمز ارز، پشتیبانی ۲۴ ساعته و رابط کاربری حرفه‌ای.",
