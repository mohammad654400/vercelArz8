    ...
    },
    {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "واریز ریال مشمول کارمزد نمی‌باشد. برداشت‌های ریالی به علت هزینه‌های درگاه‌های پرداخت مشمول حداقل هزار تومان و حداکثر 5 هزار تومان کارمزد می‌باشد. این مقدار برای تمامی برداشت‌های ریالی ثابت است."
          }
        }
      ]
    },
